...
## 💻 Projetos e Disciplinas do 1º Semestre $\color{red}{\text{(Pastas Neste Repositório)}}$ ##
...
| **Modelagem de Banco de Dados** | Engenharia de dados: MER, Normalização, SQL e brModelo. | 🎓 Sistema de Gestão Acadêmica<br>🗃️ Modelagem Conceitual, Lógica e Física | [📂 Abrir](./Disciplinas_1Semestre/Modelagem_BancoDados) |
