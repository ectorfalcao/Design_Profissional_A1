...
![Curso](https://img.shields.io/badge/Curso-Análise_e_Desenvolvimento_de_Sistemas-blue?style=for-the-badge)
![Semestre](https://img.shields.io/badge/Semestre-1º-blueviolet?style=for-the-badge)

**Aluno:** Ector Carvalho Alves Falcão  
...
Este repositório centraliza a entrega da **Avaliação A1**, demonstrando a competência em **organização digital**, **posicionamento de carreira** e **desenvolvimento técnico**.

Aqui estão reunidas evidências de engajamento com o mercado (processos seletivos e eventos), documentação profissional (Currículo LaTeX) e o portfólio técnico prático desenvolvido nas disciplinas do 1º semestre.
...
| :--- | :--- | :---: | :--- |
| **1. Processo Seletivo** | Evidência de candidatura para estágio/trainee. | ✔️ | [📄 Ver Evidência](./Repositorios_1Semestre/Design_Profissional/Portfolio/Relato_Processo_Seletivo.pdf) |
| **2. Evento Acadêmico** | Certificado de participação em evento de TI. | ✔️ | [📄 Ver Certificado](./Repositorios_1Semestre/Design_Profissional/Portfolio/Certificado_Evento.pdf) |
| **3. Currículo** | Currículo profissional desenvolvido em **LaTeX**. | ✔️ | [📄 Ver Currículo](./Repositorios_1Semestre/Design_Profissional/Portfolio/Curriculo_Latex_E_Falcao.pdf) |
...
├── Curriculo_Latex.pdf            # Currículo formatado em LaTeX
├── Certificado_Evento.pdf         # Comprovante de atividade complementar
...
│   └── Design Profissional/       # Trabalhos teóricos
